...
data_path='/Users/ali/Desktop/Aug23/CVN/rba/exvivo/divya_ex_vivo_data/FA.csv'
...
for (i in 2:len) {
  var2=as.numeric(data_div[2:dim(data_div)[1],i])
...
write.xlsx2(table, "table_fa.xlsx", sheetName = "Significants" )
